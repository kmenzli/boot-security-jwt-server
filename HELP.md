...
* The original package name 'org.training.boot.security.boot-security-jwt-server' is invalid and this project uses 'org.training.boot.security.bootsecurityjwtserver' instead.
